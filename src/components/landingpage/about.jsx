...
export default function About() {
  return (
    <section className="px-10 py-20 bg-white transition-colors">
      <h2 className="text-3xl font-bold text-blue-700 mb-8 text-center">About Prashikshan</h2>
      <div className="max-w-3xl mx-auto text-center">
        <p className="text-lg text-gray-700 mb-6">
          Prashikshan is on a mission to modernize internships, mentorship, and skill-building for students, colleges, and companies. Our NEP-compliant platform connects all stakeholders in a seamless, verified ecosystem.
        </p>
