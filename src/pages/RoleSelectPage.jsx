...
// ✅ UPDATE: Adjusted Admin route and label
const roles = [
    { 
        name: "Student", 
    ...
    { 
        name: "Admin", 
        label: "Request Admin Access", // Adjusted label to match signup context
        route: "/adminsignup", // <--- ROUTE CHANGED HERE
        color: "gray", 
        Icon: AdminIcon 
    },
];
                    ...
                    {roles.map((role) => (
                        <button
                            ...
                            className={`
                                ...
                                transition
                            `}
                            onClick={() => navigate(role.route)} // ✅ Uses the updated 'route'
                        >
                            <role.Icon />
